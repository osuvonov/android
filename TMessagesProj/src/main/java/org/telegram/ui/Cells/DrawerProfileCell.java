...
public class DrawerProfileCell extends FrameLayout {
    ...
    public DrawerProfileCell(Context context) {
        ...
        companyNameTextView = new TextView(context);
        companyNameTextView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 15);
        companyNameTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        companyNameTextView.setLines(1);
        companyNameTextView.setMaxLines(1);
        companyNameTextView.setSingleLine(true);
        companyNameTextView.setGravity(Gravity.LEFT);
        companyNameTextView.setEllipsize(TextUtils.TruncateAt.END);
        addView(companyNameTextView, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT, Gravity.LEFT | Gravity.BOTTOM, 16, 0, 76, 28));
