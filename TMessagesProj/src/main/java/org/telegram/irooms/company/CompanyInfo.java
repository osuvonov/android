...
public class CompanyInfo extends BaseFragment {
    ...
    private void removeMemberFromCompany(int position, int id) {
        ...
        members.add(id);
        IRoomsManager.getInstance().deleteMembersFromCompany(getParentActivity(), mCompany.getId(), members, new IRoomsManager.IRoomsCallback() {
            @Override
