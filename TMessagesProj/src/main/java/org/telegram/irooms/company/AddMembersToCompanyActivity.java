...
public class AddMembersToCompanyActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, View.OnClickListener {
            ...
            if (!animationStarted) {
                ...
                if (currentAnimation != null) {
                    ...
                    if (containerHeight != resultHeight) {
                        animators.add(ObjectAnimator.ofInt(AddMembersToCompanyActivity.this, "containerHeight", resultHeight));
                    }
    ...
    public AddMembersToCompanyActivity() {
        super();
    }
        ...
        listView.setOnItemClickListener((view, position) -> {
            if (position == 0 && adapter.inviteViaLink != 0 && !adapter.searching) {
                ...
                if (exists = selectedContacts.indexOfKey(id) >= 0) {
                    ...
                    span.setOnClickListener(AddMembersToCompanyActivity.this);
                }
                updateHint();
