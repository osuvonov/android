...
public class ChatTaskCell extends BaseCell implements DownloadController.FileDownloadProgressListener {

    public interface ChatActionCellDelegate {
        default void didClickImage(ChatTaskCell cell) {
        }

        default void didLongPress(ChatTaskCell cell, float x, float y) {
        }
        ...
        default void didPressReplyMessage(ChatTaskCell cell, int id) {
        }
    }
    ...
    public ChatTaskCell(Context context) {
        super(context);
